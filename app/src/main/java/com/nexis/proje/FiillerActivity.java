...
public class FiillerActivity extends AppCompatActivity {
    private WebView gif;
    private Button bIleri, bGeri;
    private TextView txtHarf;
    private String[] kelimeler={"almak","aramak","atlamak","bağırmak","bakmak","başarmak","beğenmek","beklemek","benzemek","bıkmak","bilmel","binmek","gezmek","gel","git","koyu"};
    private int s=-1, h=0;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_fiiller);
