...
public class SporActivity extends AppCompatActivity {
    ...
    private String[] kelimeler={"spor","forma","futbol","basketbol","güneş","voleybol","hentbol","tenis","maraton","okçuluk","yüzme","halter","boks","karate","dart","kayak","paten","ip atlama","sörf","krampon","masör","madalya","galip","final","kura","turnuva","sarı kart","kırmızı kart","faul"
            ,"derbi","takım","kulüp","fenerbahce","beşiktaş","galatasaray"};
    private int s=-1, h=0;
    ...
    public void filePath(int indx){
        for (int i=0; i<kelimeler.length;i++){
            if (i==indx){
                String file="file:android_asset/spor/"+kelimeler[i]+".gif";
                gif.loadUrl(file);
            }
        }
    }
